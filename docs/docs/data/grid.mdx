...
| `selectionMode`  | `"none" \| "cell" \| "row"`  | `"cell"` | What gets `aria-selected` on click/Enter — the cell or the whole row     |
| `multiSelect`    | `boolean`                    | `false`  | Allow multiple cells/rows to be selected at once                         |
