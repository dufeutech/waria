...
State is exposed via host attributes (`[pressed]`, `[disabled]`) and via `aria-pressed` on the trigger.
...
| Selector                                            | Targets         |
| --------------------------------------------------- | --------------- |
| `w-switch[pressed]`                                 | On state        |
| `w-switch[disabled]`                                | Disabled        |
| `w-switch w-slot[trigger] > *[aria-pressed="true"]` | Pressed trigger |
